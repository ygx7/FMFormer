...
def parse_args():
    ...
    parser.add_argument('-lrd', '--lr-decay', default=0.98, type=float, metavar='LR', help='learning rate decay per epoch')
    ...
    parser.add_argument('--edgepad', default=81, type=int, help='Used to supplement edge frame length')
